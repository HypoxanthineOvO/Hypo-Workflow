...
This page lists the files Hypo-Workflow generates automatically (derived artifacts), what each one is generated from, and which command repairs it — for anyone debugging a stale generated file.

These files are generated by core helpers or sync/docs commands. Change the source helper or authority file first, then run repair/sync. Do not treat generated artifacts as source of truth; if one is stale, check its source and writer command first.
