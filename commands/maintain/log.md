...
Load the corresponding Hypo-Workflow skill instructions from `skills/maintain/SKILL.md`, then execute `/hw:maintain log` semantics with any user-provided arguments.
