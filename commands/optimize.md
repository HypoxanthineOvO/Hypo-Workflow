...
Load the corresponding Hypo-Workflow skill instructions from `skills/optimize/SKILL.md`, then execute `/hw:optimize` semantics with any user-provided arguments.
