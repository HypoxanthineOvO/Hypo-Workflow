...
Load the corresponding Hypo-Workflow skill instructions from `skills/plan-confirm/SKILL.md`, then execute `/hw:plan:confirm` semantics with any user-provided arguments.
