...
Load the corresponding Hypo-Workflow skill instructions from `skills/explain/SKILL.md`, then execute `/hw:explain` semantics with any user-provided arguments.
