...
export function docsMap() {
  return {
    ...
    documents: [
      ...
      {
        path: "docs/release/v12.5.2.md",
        role: "release_note",
        update_class: "release_note",
        sources: ["CHANGELOG.md", ".pipeline/pr/PR-20260512-001/summary.md"],
        managed_blocks: [],
        narrative_update_policy: "release_flow",
        must_not_include: [],
      },
      {
        path: "docs/en/release/v12.5.2.md",
        role: "english_release_note",
        update_class: "release_note_translation",
        sources: ["docs/release/v12.5.2.md", "CHANGELOG.md"],
        managed_blocks: [],
        narrative_update_policy: "release_flow",
        must_not_include: [],
      },
...
function renderEnglishReadme() {
  return [
    ...
    "",
    `[![Version](https://img.shields.io/badge/version-12.5.2-blue)](.claude-plugin/plugin.json)`,
    ...
    "| [v12.5.2 Release Notes](docs/en/release/v12.5.2.md) | OpenCode bash auto-approval now uses valid schema plus plugin policy, with local distribution refreshed |",
    "",
    "## License",
    "",
