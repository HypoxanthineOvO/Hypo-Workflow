...
export function docsMap() {
  return {
    ...
    documents: [
      ...
      {
        path: "docs/release/v12.8.1.md",
        role: "release_note",
        update_class: "release_note",
        sources: ["CHANGELOG.md", ".pipeline/pr/PR-20260517-001/summary.md"],
        managed_blocks: [],
        narrative_update_policy: "release_flow",
        must_not_include: [],
      },
      {
        path: "docs/en/release/v12.8.1.md",
        role: "english_release_note",
        update_class: "release_note_translation",
        sources: ["docs/release/v12.8.1.md", "CHANGELOG.md"],
        managed_blocks: [],
        narrative_update_policy: "release_flow",
        must_not_include: [],
      },
...
function renderEnglishReadme() {
  return [
    ...
    "",
    `[![Version](https://img.shields.io/badge/version-12.8.1-blue)](.claude-plugin/plugin.json)`,
    ...
    "| [v12.8.1 Release Notes](docs/en/release/v12.8.1.md) | Cursor flat Skills/commands sync, self-contained `/hw-setup`, and PR #8 merge |",
    "",
    "## License",
    "",
