  ...
  return {
    ...
    documents: [
      ...
      },
      {
        ...
        sources: ["CHANGELOG.md", ".pipeline/reports/08-final-gated-notion-apply-verification.report.md", ".pipeline/acceptance/cycle-C16-rejection-20260520T130827+0800.yaml"],
        managed_blocks: [],
