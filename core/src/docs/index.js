...
export function docsMap() {
  return {
    ...
    documents: [
      ...
      {
        path: "docs/release/v15.0.0-alpha.2.md",
        role: "release_note",
      ...
      {
        path: "docs/en/release/v15.0.0-alpha.2.md",
        role: "english_release_note",
        update_class: "release_note_translation",
        sources: ["docs/release/v15.0.0-alpha.2.md", "CHANGELOG.md"],
        managed_blocks: [],
        narrative_update_policy: "release_flow",
        must_not_include: [],
      },
...
function renderEnglishReadme() {
  return [
    ...
    "",
    `[![Version](https://img.shields.io/badge/version-15.0.0-alpha.2-blue)](.claude-plugin/plugin.json)`,
    ...
    "| [v15.0.0-alpha.2 Release Notes](docs/en/release/v15.0.0-alpha.2.md) | Generic History Refresh and trustworthy current release gates |",
    "",
    "## License",
    "",
