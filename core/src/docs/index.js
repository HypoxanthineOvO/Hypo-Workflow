...
export function docsMap() {
  return {
    ...
    documents: [
      ...
      {
        path: "docs/en/release/v12.4.0.md",
        role: "english_release_note",
        update_class: "release_note_translation",
        sources: ["docs/release/v12.4.0.md", "CHANGELOG.md", ".pipeline/log.yaml"],
        managed_blocks: [],
        narrative_update_policy: "release_flow",
        must_not_include: [],
      },
...
function renderEnglishReadme() {
  return [
    ...
    "| Handle existing PR/MR | `/hw:pr inspect|review|fix|merge|close <url|id>` |",
    ...
    "| [v12.4.0 Release Notes](docs/en/release/v12.4.0.md) | Chinese-first workflow surfaces, planning discipline, Subagent injection, and validation evidence |",
    "",
    "## License",
    "",
