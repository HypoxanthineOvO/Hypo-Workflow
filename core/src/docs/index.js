...
export function docsMap() {
  return {
    ...
    documents: [
      ...
      {
        path: "docs/release/v15.0.0-alpha.1.md",
        role: "release_note",
      ...
      {
        path: "docs/en/release/v15.0.0-alpha.1.md",
        role: "english_release_note",
        update_class: "release_note_translation",
        sources: ["docs/release/v15.0.0-alpha.1.md", "CHANGELOG.md"],
        managed_blocks: [],
        narrative_update_policy: "release_flow",
        must_not_include: [],
      },
...
function renderEnglishReadme() {
  return [
    ...
    "",
    `[![Version](https://img.shields.io/badge/version-15.0.0-alpha.1-blue)](.claude-plugin/plugin.json)`,
    ...
    "| [v15.0.0-alpha.1 Release Notes](docs/en/release/v15.0.0-alpha.1.md) | Semantic Cycles, readable recovery, and six focused Hooks |",
    "",
    "## License",
    "",
