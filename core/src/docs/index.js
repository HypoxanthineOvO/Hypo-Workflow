...
export function docsMap() {
  return {
    ...
    documents: [
      ...
      {
        path: "docs/release/v14.0.0-alpha.5.md",
        role: "release_note",
      ...
      {
        path: "docs/en/release/v14.0.0-alpha.5.md",
        role: "english_release_note",
        update_class: "release_note_translation",
        sources: ["docs/release/v14.0.0-alpha.5.md", "CHANGELOG.md"],
        managed_blocks: [],
        narrative_update_policy: "release_flow",
        must_not_include: [],
      },
...
function renderEnglishReadme() {
  return [
    ...
    "",
    `[![Version](https://img.shields.io/badge/version-14.0.0-alpha.5-blue)](.claude-plugin/plugin.json)`,
    ...
    "| [v14.0.0-alpha.5 Release Notes](docs/en/release/v14.0.0-alpha.5.md) | Self-contained Hook packages and terminal compaction safety |",
    "",
    "## License",
    "",
