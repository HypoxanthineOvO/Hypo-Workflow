...
export function docsMap() {
  return {
    ...
    documents: [
      ...
      {
        path: "docs/release/v13.1.0-beta.3.md",
        role: "release_note",
      ...
      {
        path: "docs/en/release/v13.1.0-beta.3.md",
        role: "english_release_note",
        update_class: "release_note_translation",
        sources: ["docs/release/v13.1.0-beta.3.md", "CHANGELOG.md"],
        managed_blocks: [],
        narrative_update_policy: "release_flow",
        must_not_include: [],
      },
...
function renderEnglishReadme() {
  return [
    ...
    "",
    `[![Version](https://img.shields.io/badge/version-13.1.0-beta.3-blue)](.claude-plugin/plugin.json)`,
    ...
    "| [v13.1.0-beta.3 Release Notes](docs/en/release/v13.1.0-beta.3.md) | Manifest Core, Host Contract v1, and verified host distribution |",
    "",
    "## License",
    "",
