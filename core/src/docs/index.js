...
export function docsMap() {
  return {
    ...
    documents: [
      ...
      {
        path: "docs/release/v14.0.0-alpha.1.md",
        role: "release_note",
        update_class: "release_note",
        sources: ["CHANGELOG.md", "contracts/host/v1/command-manifest.json", "contracts/host/v1/release-manifest.schema.json", "scripts/build-host-artifacts.mjs"],
        managed_blocks: [],
        narrative_update_policy: "release_flow",
        must_not_include: [],
      },
      {
        path: "docs/en/release/v14.0.0-alpha.1.md",
        role: "english_release_note",
        update_class: "release_note_translation",
        sources: ["docs/release/v14.0.0-alpha.1.md", "CHANGELOG.md"],
        managed_blocks: [],
        narrative_update_policy: "release_flow",
        must_not_include: [],
      },
...
function renderEnglishReadme() {
  return [
    ...
    "",
    `[![Version](https://img.shields.io/badge/version-14.0.0-alpha.1-blue)](.claude-plugin/plugin.json)`,
    ...
    "| [v14.0.0-alpha.1 Release Notes](docs/en/release/v14.0.0-alpha.1.md) | Manifest Core, Host Contract v1, and verified host distribution |",
    "",
    "## License",
    "",
