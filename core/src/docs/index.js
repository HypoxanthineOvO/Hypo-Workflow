...
export function docsMap() {
  return {
    ...
    documents: [
      ...
      {
        path: "docs/release/v14.0.0-alpha.6.md",
        role: "release_note",
        update_class: "release_note",
        sources: ["CHANGELOG.md", "core/src/codex-hooks/index.js", "skills/experiment/SKILL.md", "core/src/index.js"],
        managed_blocks: [],
        narrative_update_policy: "release_flow",
        must_not_include: [],
      },
      {
        path: "docs/en/release/v14.0.0-alpha.6.md",
        role: "english_release_note",
        update_class: "release_note_translation",
        sources: ["docs/release/v14.0.0-alpha.6.md", "CHANGELOG.md"],
        managed_blocks: [],
        narrative_update_policy: "release_flow",
        must_not_include: [],
      },
...
function renderEnglishReadme() {
  return [
    ...
    "",
    `[![Version](https://img.shields.io/badge/version-14.0.0-alpha.6-blue)](.claude-plugin/plugin.json)`,
    ...
    "| [v14.0.0-alpha.6 Release Notes](docs/en/release/v14.0.0-alpha.6.md) | Ordinary-file experiment records, non-blocking Hooks, and restored root exports |",
    "",
    "## License",
    "",
