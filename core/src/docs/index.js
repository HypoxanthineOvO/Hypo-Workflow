...
export function docsMap() {
  return {
    ...
    documents: [
      ...
      {
        path: "docs/release/v14.0.0-alpha.4.md",
        role: "release_note",
        update_class: "release_note",
        sources: ["CHANGELOG.md", "core/src/work-placement/index.js", "core/src/repository-targets/index.js", "core/test/concurrent-work-placement-contract.test.js"],
        managed_blocks: [],
        narrative_update_policy: "release_flow",
        must_not_include: [],
      },
      {
        path: "docs/en/release/v14.0.0-alpha.4.md",
        role: "english_release_note",
        update_class: "release_note_translation",
        sources: ["docs/release/v14.0.0-alpha.4.md", "CHANGELOG.md"],
        managed_blocks: [],
        narrative_update_policy: "release_flow",
        must_not_include: [],
      },
...
function renderEnglishReadme() {
  return [
    ...
    "",
    `[![Version](https://img.shields.io/badge/version-14.0.0-alpha.4-blue)](.claude-plugin/plugin.json)`,
    ...
    "| [v14.0.0-alpha.4 Release Notes](docs/en/release/v14.0.0-alpha.4.md) | Concurrent Work Placement, Repository Targets, and integration gates |",
    "",
    "## License",
    "",
