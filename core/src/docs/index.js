  ...
  return {
    ...
    documents: [
      ...
      },
      {
        ...
        update_class: "generated_reference",
        sources: ["references/config-spec.md", "config.schema.yaml", "core/src/config/index.js", "core/src/analysis/index.js", "core/src/worker-routing/index.js"],
        managed_blocks: [],
        narrative_update_policy: "generated",
        must_not_include: [],
      },
      ...
      {
        path: "docs/release/v14.0.0-alpha.2.md",
        role: "release_note",
        update_class: "release_note",
        sources: ["CHANGELOG.md", "skills/experiment/SKILL.md", "core/src/worker-routing/index.js", "core/src/codex-hooks/index.js", "contracts/host/v1/command-manifest.json", "contracts/host/v1/release-manifest.schema.json", "scripts/build-host-artifacts.mjs"],
        managed_blocks: [],
        narrative_update_policy: "release_flow",
        must_not_include: [],
      },
      {
        path: "docs/en/release/v14.0.0-alpha.2.md",
        role: "english_release_note",
        update_class: "release_note_translation",
        sources: ["docs/release/v14.0.0-alpha.2.md", "CHANGELOG.md"],
        managed_blocks: [],
        narrative_update_policy: "release_flow",
        must_not_include: [],
      },
...
function renderEnglishReadme() {
  return [
    ...
    "",
    `[![Version](https://img.shields.io/badge/version-14.0.0-alpha.2-blue)](.claude-plugin/plugin.json)`,
    ...
    "| [v14.0.0-alpha.2 Release Notes](docs/en/release/v14.0.0-alpha.2.md) | Experiment management, semantic Worker Routing, and Hook compatibility |",
    "",
    "## License",
    "",
...
function platformFeatureLines(platform) {
  ...
  if (platform === "codex") {
    return [
      ...
      "- topology 固定后，宿主 AI 在 Worker 启动前生成并显示 Task Assessment；Core 只验证并输出 semantic routing class。",
      "- `execution.worker_routing.mode=advisory|required|off` 控制 semantic handoff；路由不改变角色、证据、验收或用户授权。",
...
function englishPlatformFeatureLines(platform) {
  ...
  if (platform === "codex") {
    return [
      ...
      "- After topology is fixed, the host AI generates and shows a Task Assessment before Worker start; Core only validates it and emits a semantic routing class.",
      "- `execution.worker_routing.mode=advisory|required|off` controls the semantic handoff; routing never changes roles, evidence, acceptance, or user authority.",
