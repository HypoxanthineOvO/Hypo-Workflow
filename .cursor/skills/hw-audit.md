---
name: hw-audit
description: "Hypo-Workflow Cursor skill for /hw-audit; use when the user invokes /hw-audit or canonical /hw:audit."
---

# /hw-audit

Canonical command: `/hw:audit`
Cursor command: `/hw-audit`
Route: `review`
Embedded authority source: `skills/audit/SKILL.md`
...
3. Execute the canonical `/hw:audit` semantics using the embedded command authority below and any user-provided arguments.
