---
name: hw-pr-create
description: "Hypo-Workflow Cursor skill for /hw-pr-create; use when the user invokes /hw-pr-create or canonical /hw:pr create."
---

# /hw-pr-create

Canonical command: `/hw:pr create`
Cursor command: `/hw-pr-create`
...
3. Execute the canonical `/hw:pr create` semantics using the embedded command authority below and any user-provided arguments.
