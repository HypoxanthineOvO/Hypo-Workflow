---
name: hw-guide
description: "Hypo-Workflow Cursor skill for /hw-guide; use when the user invokes /hw-guide or canonical /hw:guide."
---

# /hw-guide

Canonical command: `/hw:guide`
Cursor command: `/hw-guide`
Route: `plan`
Embedded authority source: `skills/guide/SKILL.md`
...
3. Execute the canonical `/hw:guide` semantics using the embedded command authority below and any user-provided arguments.
