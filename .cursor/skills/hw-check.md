---
name: hw-check
description: "Hypo-Workflow Cursor skill for /hw-check; use when the user invokes /hw-check or canonical /hw:check."
---

# /hw-check

Canonical command: `/hw:check`
Cursor command: `/hw-check`
Route: `read`
Embedded authority source: `skills/check/SKILL.md`
...
3. Execute the canonical `/hw:check` semantics using the embedded command authority below and any user-provided arguments.
