---
name: hw-plan
description: "Hypo-Workflow Cursor skill for /hw-plan; use when the user invokes /hw-plan or canonical /hw:plan."
---

# /hw-plan

Canonical command: `/hw:plan`
Cursor command: `/hw-plan`
Route: `plan`
Embedded authority source: `skills/plan/SKILL.md`
...
3. Execute the canonical `/hw:plan` semantics using the embedded command authority below and any user-provided arguments.
