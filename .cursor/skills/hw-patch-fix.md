---
name: hw-patch-fix
description: "Hypo-Workflow Cursor skill for /hw-patch-fix; use when the user invokes /hw-patch-fix or canonical /hw:patch fix."
---

# /hw-patch-fix

Canonical command: `/hw:patch fix`
Cursor command: `/hw-patch-fix`
Route: `fix`
Embedded authority source: `skills/patch/SKILL.md`
...
3. Execute the canonical `/hw:patch fix` semantics using the embedded command authority below and any user-provided arguments.
