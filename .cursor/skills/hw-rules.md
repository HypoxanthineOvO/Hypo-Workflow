---
name: hw-rules
description: "Hypo-Workflow Cursor skill for /hw-rules; use when the user invokes /hw-rules or canonical /hw:rules."
---

# /hw-rules

Canonical command: `/hw:rules`
Cursor command: `/hw-rules`
Route: `rules`
Embedded authority source: `skills/rules/SKILL.md`
...
3. Execute the canonical `/hw:rules` semantics using the embedded command authority below and any user-provided arguments.
