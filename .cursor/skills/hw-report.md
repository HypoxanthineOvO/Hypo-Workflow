---
name: hw-report
description: "Hypo-Workflow Cursor skill for /hw-report; use when the user invokes /hw-report or canonical /hw:report."
---

# /hw-report

Canonical command: `/hw:report`
Cursor command: `/hw-report`
Route: `read`
Embedded authority source: `skills/report/SKILL.md`
...
3. Execute the canonical `/hw:report` semantics using the embedded command authority below and any user-provided arguments.
