---
name: hw-resume
description: "Hypo-Workflow Cursor skill for /hw-resume; use when the user invokes /hw-resume or canonical /hw:resume."
---

# /hw-resume

Canonical command: `/hw:resume`
Cursor command: `/hw-resume`
Route: `pipeline`
Embedded authority source: `skills/resume/SKILL.md`
...
3. Execute the canonical `/hw:resume` semantics using the embedded command authority below and any user-provided arguments.
