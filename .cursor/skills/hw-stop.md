---
name: hw-stop
description: "Hypo-Workflow Cursor skill for /hw-stop; use when the user invokes /hw-stop or canonical /hw:stop."
---

# /hw-stop

Canonical command: `/hw:stop`
Cursor command: `/hw-stop`
Route: `pipeline`
Embedded authority source: `skills/stop/SKILL.md`
...
3. Execute the canonical `/hw:stop` semantics using the embedded command authority below and any user-provided arguments.
