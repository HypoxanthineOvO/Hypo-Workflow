---
name: hw-patch
description: "Hypo-Workflow Cursor skill for /hw-patch; use when the user invokes /hw-patch or canonical /hw:patch."
---

# /hw-patch

Canonical command: `/hw:patch`
Cursor command: `/hw-patch`
Route: `lifecycle`
...
3. Execute the canonical `/hw:patch` semantics using the embedded command authority below and any user-provided arguments.
