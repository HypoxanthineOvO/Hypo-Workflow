---
name: hw-start
description: "Hypo-Workflow Cursor skill for /hw-start; use when the user invokes /hw-start or canonical /hw:start."
---

# /hw-start

Canonical command: `/hw:start`
Cursor command: `/hw-start`
Route: `pipeline`
Embedded authority source: `skills/start/SKILL.md`
...
3. Execute the canonical `/hw:start` semantics using the embedded command authority below and any user-provided arguments.
