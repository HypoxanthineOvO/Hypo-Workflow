---
name: hw-explain
description: "Hypo-Workflow Cursor skill for /hw-explain; use when the user invokes /hw-explain or canonical /hw:explain."
---

# /hw-explain

Canonical command: `/hw:explain`
Cursor command: `/hw-explain`
Route: `explain`
Embedded authority source: `skills/explain/SKILL.md`
...
3. Execute the canonical `/hw:explain` semantics using the embedded command authority below and any user-provided arguments.
