...
Secondary implementation worker for parallel scoped code changes.
...
When using DeepSeek through OpenCode, follow these rules strictly. They override any conflicting habits from chat training.
